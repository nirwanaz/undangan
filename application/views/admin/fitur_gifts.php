            ...
            <div class="main-content">
                <div class="section__content section__content--p30">
                    <div class="row">
                        <div class="col-md-12">
                            <!-- DATA TABLE -->
                            <h3 class="title-5 m-b-35">Data Table Gift Method</h3>
                            <div class="table-data__tool">
                                ...
                                <div class="table-data__tool-right">
                                    <button class="au-btn au-btn-icon au-btn--green au-btn--small" data-toggle="modal" data-target="#formModal">
                                        <i class="zmdi zmdi-plus"></i>Add Gift Method</button>
                                ...
                                <table class="table table-data2">
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="tr-shadow">
                                            ...
                                            <td>
                                                <img src="<?php echo base_url('assets/image/gift/'.$gift->background) ?>" alt="<?php echo $gift->name ?>" width="100" height="50">
                                            </td>
                                            <td>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form enctype="multipart/form-data">
                        <div class="mb-3">
                            <label for="giftMethodName">Gift Method Name</label>
                            <input type="text" class="form-control" name="name">
                        </div>
                        <div class="mb-3">
                            <label for="giftMethodSrc">Upload Image</label>
