...
class Order extends CI_Controller {
    ...
    function store() {
        ...
        $this->wedding->field['name'] = $post['wedding_name'];
        $this->wedding->insert();
